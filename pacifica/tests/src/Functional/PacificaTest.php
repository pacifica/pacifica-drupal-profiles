...
/**
 * Tests Pacifica installation profile expectations.
 *
 * @group pacifica
 */
class PacificaTest extends BrowserTestBase {
  ...
  /**
   * Tests Pacifica installation profile.
   */
  public function testPacifica() {
    $this->drupalGet('');
    ...
    // pacifica profile modules are enabled.
    ...
    // Ensure that configuration from the Pacifica profile is not reused when
